...
esp_err_t spi_sd_init() {
    ...
    spi_device_interface_config_t devcfg = {
        .clock_speed_hz = SPI_CLOCK_SPEED_SD,  // You might want to adjust this for SD card
        .mode = 0,
    ...
    host.max_freq_khz = SPI_CLOCK_SPEED_SD / 1000;
...
esp_err_t spi_hx8357_init() {
    ...
    spi_device_interface_config_t devcfg={
        .clock_speed_hz = SPI_CLOCK_SPEED_DISP,
        .mode = 0,
